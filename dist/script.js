import { getMovieObjects } from "./Movies.js";
...
const movies = []; //   Lagrar filmerna så att de kan återanvändas utan extra fetcher
getMovieObjects().then(movies => {
    ...
    movies === null || movies === void 0 ? void 0 : movies.forEach(movie => {
        ...
        moviePicker === null || moviePicker === void 0 ? void 0 : moviePicker.appendChild(option);
    });
});
